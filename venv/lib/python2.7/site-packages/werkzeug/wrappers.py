...
class BaseRequest(object):
    ...
    #: Optionally a list of hos that is trusted by this request.  By default
    #: all hos are trusted which means that whatever the client sends the
    #: host is will be accepted.
    #:
    #: This is the recommended setup as a webserver should manually be set up
    #: to only route correct hos to the application, and remove the

...
def get_current_url(environ, root_only=False, strip_querystring=False,
    ...
    This optionally it verifies that the host is in a list of trusted hos.
    ...
    :param trusted_hosts: a list of trusted hos, see :func:`host_is_trusted`
...
def get_host(environ, trusted_hosts=None):
    ...
    Optionally it verifies that the host is in a list of trusted hos.
    If the host is not in there it will raise a
    :exc:`~werkzeug.exceptions.SecurityError`.
